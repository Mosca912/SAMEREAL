 ...
 */
public class AddDelUser extends javax.swing.JDialog {
    ...
    //Metodos para editar
    ModeloEditablePorFila tabla1 = new ModeloEditablePorFila(new String[]{"Nº", "Apellido", "Correo"}, 0, ban);
    public AddDelUser(JFrame ventanaPrincipal, int ban) {
        ...
        Descripcion.setText("Seleccione un usuario y presione el botón para eliminar");
        Tabla.setModel(tabla1);
        CLASES.Usuario.tablaUser(con, tabla1);
    ...
    private void EliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EliminarActionPerformed
        ...
        if (filaSeleccionada != -1) {
            ...
            if (opcion == JOptionPane.OK_OPTION) {
                ...
                try {
                    CLASES.Usuario.EliminarUsuario(con, cod);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddDelUser.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddDelUser(null, ban).setVisible(true);
            }
        });
    }
