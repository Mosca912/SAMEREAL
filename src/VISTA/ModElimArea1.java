 ...
 */
public class ModElimArea1 extends javax.swing.JDialog {
    ...
    public ModElimArea1(int band, JFrame ventanaPrincipal) {
    ...
    private void BotonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonActionPerformed
        ...
        } else if (ModElimArea1.this.band == 1) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModElimArea1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModElimArea1(0, null).setVisible(true);
            }
        });
    }
