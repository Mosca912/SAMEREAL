...
public class Asistencia {
    ...
    public static void iniciarContador(Connection conexion, LocalDateTime entrada, JLabel destinoLabel) {
        ...
        timer = new Timer(1000, (ActionEvent e) -> {
            LocalDateTime fin = entrada.plusHours(24);
            LocalDateTime ahora = LocalDateTime.now();
            
            if (ahora.isBefore(fin)) {
                long minutosTotales = ChronoUnit.MINUTES.between(ahora, fin);
                long horas = minutosTotales / 60;
                long minutos = minutosTotales % 60;
                destinoLabel.setText("Faltan: " + horas + "h " + minutos + "min");
            } else {
                destinoLabel.setText("El turno ya terminó");
